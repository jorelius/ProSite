...
* **Cloud:** AWS (ECS, Lambda, DynamoDB, S3, Fargate, CloudFront, OpenSearch)
* **Languages:** Rust, Java, TypeScript, C#/.NET
* **Domains:** Distributed systems, autoscaling, cost optimization, AI/ML productionization

## Open source

* [Fenrir](https://github.com/jorelius/Fenrir): Service benchmark testing framework
* [Speak](https://github.com/jorelius/Speak): Text-to-speech command line tool
* [Watch](https://github.com/jorelius/Watch): Trigger actions on resource changes
* [JSON Http Request Tree](https://github.com/jorelius/json-httprequest-tree): JSON standard for HTTP request chains
